<%@ Page Title="Application Resources" Language="C#" MasterPageFile="~/application/MasterPage.master" AutoEventWireup="true" CodeFile="UserGroupResourceList.aspx.cs" Inherits="UserGroupResourceList" %>
                                    ...
                                    <div class="ibox-title" style="border-style: none;">
                                        <table style="width: 100%;">
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 id="h1" runat="server" class="modal-title">Group Access Right</h2>
                                                </td>
                                    ...
                                    <div class="ibox-title" style="border-style: none;">
                                        <table style="width: 100%;">
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="modal-title">Access Right Details</h2>
                                                </td>
                                    ...
                                    <div class="ibox-content" style="padding-right: 10px; padding-left: 10px;">
                                        <div id="detailsregion" runat="server" style="padding: 10px;" class="row">
                                            ...
                                            <div class="form-group">
                                               <asp:TextBox ID="groupname_db" runat="server" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            <br />



                                            <div style="overflow: scroll; border-style: ridge; height: 300px;">
                                                <asp:GridView runat="server" class="table table-bordered" ID="resoucesgrid" AutoGenerateColumns="False" Width="100%" DataSourceID="EntityDataSource2" HeaderStyle-BackColor="#F5F5F6" PageSize="5" EmptyDataText="No Record to display">
                                                    <Columns>
                                                        <asp:TemplateField ItemStyle-Width="20">

                                                            <ItemTemplate>
                                                                <asp:CheckBox runat="server" CssClass="form-control" ID="checkbox" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="Id"  ItemStyle-Width="1" ReadOnly="True" SortExpression="ApplicationResource_Id"></asp:BoundField>

                                                        <asp:BoundField DataField="ResouceName" HeaderText="Resource Name" ReadOnly="True" SortExpression="Id"></asp:BoundField>
                                                    </Columns>
                                                </asp:GridView>
                                                <asp:EntityDataSource runat="server" OrderBy="it.Id" ID="EntityDataSource2" DefaultContainerName="CCMSEntities" ConnectionString="name=CCMSEntities" EnableFlattening="False" EntitySetName="ApplicationResources" Select="distinct  it.[Id], it.[ResouceName]"></asp:EntityDataSource>
