<%@ Page Title="Application Resources" Language="C#" MasterPageFile="~/application/MasterPage.master" AutoEventWireup="true" CodeFile="ApplicationResourceList.aspx.cs" Inherits="ApplicationResourceList" %>
                                    ...
                                    <div class="ibox-title" style="border-style: none;">
                                        <table style="width: 100%;">
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 id="h1" runat="server" class="modal-title">Application Resources</h2>
                                                </td>
                                    ...
                                    <il class="fa fa-download"></il>
                                        ...
                                        <asp:GridView ID="GridView1" class="table table-bordered" runat="server" AutoGenerateColumns="False" DataSourceID="EntityDataSource1" AllowPaging="True" HeaderStyle-BackColor="#F5F5F6" PageSize="5" EmptyDataText="No Record to display">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ResouceName" HeaderText="Resouce Name" ReadOnly="True" SortExpression="ResouceName"></asp:BoundField>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="150" ItemStyle-HorizontalAlign="Center">
                                                    ...
                                                    <il class="fa fa-caret-down"></il>
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a onclick="deleterec('<%#Eval("Id") %>')" class="dropdown-item" href="#">Delete</a></li>
                                                            </ul>
                                                        </div>
                                        ...
                                        <asp:EntityDataSource runat="server" OnSelected="EntityDataSource1_Selected" OrderBy="it.Id" ID="EntityDataSource1" DefaultContainerName="CCMSEntities" ConnectionString="name=CCMSEntities" EnableFlattening="False" EntitySetName="ApplicationResources" Select="it.[Id], it.[ResouceName]"></asp:EntityDataSource>
                                ...
                                <div class="ibox">
                                    ...
                                    <div class="ibox-content" style="padding-right: 10px; padding-left: 10px;">
                                        <div id="detailsregion" runat="server" style="padding: 10px;" class="row">
                                            ...
                                            <br />
                                            <label>Resouce Name</label>
                                            <div class="form-group">
                                                <asp:TextBox ID="ResouceName_db" runat="server" class="form-control">
                                                 </asp:TextBox>
                                            </div>
                                            <br />
                                        </div>
