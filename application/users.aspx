<%@ Page Title="Users" Language="C#" MasterPageFile="~/application/MasterPage.master" AutoEventWireup="true" CodeFile="users.aspx.cs" Inherits="users" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                    ...
                                    <div class="ibox-title" style="border-style: none;">
                                        <table style="width: 100%;">
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 id="h1" runat="server" class="modal-title">Users</h2>
                                                </td>
                                    ...
                                    <il class="fa fa-download"></il>
                                        ...
                                        <asp:GridView ID="GridView1" class="table table-bordered" runat="server" AutoGenerateColumns="False" DataSourceID="EntityDataSource1" AllowPaging="True" HeaderStyle-BackColor="#F5F5F6" PageSize="5" EmptyDataText="No Record to display" OnPageIndexChanging="GridView1_PageIndexChanging">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Login" HeaderText="Login" ReadOnly="True" SortExpression="Login"></asp:BoundField>
                                                <asp:BoundField DataField="GroupName" HeaderText="User Group" ReadOnly="True" SortExpression="GroupName"></asp:BoundField>
                                                <asp:BoundField DataField="UserStatus" HeaderText="User Status" ReadOnly="True" SortExpression="UserStatus"></asp:BoundField>
                                                <asp:BoundField DataField="CategoryName" HeaderText="CategoryName" ReadOnly="True" SortExpression="CategoryName"></asp:BoundField>
                                        ...
                                        <asp:EntityDataSource runat="server" OnSelected="EntityDataSource1_Selected" OrderBy="it.Id" ID="EntityDataSource1" DefaultContainerName="CCMSEntities" ConnectionString="name=CCMSEntities" EnableFlattening="False" EntitySetName="User_View" Select="it.[Id], it.[Login],it.[GroupName],it.[UserStatus],it.[CategoryName]"></asp:EntityDataSource>
                                    ...
                                    <div class="ibox-content" style="padding-right: 10px; padding-left: 10px;">
                                        <div id="detailsregion" runat="server" style="padding: 10px;" class="row">
                                            ...
                                            <div class="form-group">
                                                <asp:TextBox ID="Login_db" runat="server" class="form-control compulsory"></asp:TextBox>
                                            </div>

                                            <label>User Team Email</label>
                                            <div class="form-group">
                                                <asp:DropDownList ID="drpTeam_email"  runat="server" class="form-control "></asp:DropDownList> 
                                            </div>
                                            ...
                                            <label>Group</label>
                                            <div class="form-group">
                                                <asp:DropDownList ID="Group_Id_db" runat="server" class="form-control compulsory">
                                            ...
                                            <div class="form-group">
                                                <asp:DropDownList ID="UserType_db" runat="server" class="form-control compulsory">
                                                    <asp:ListItem Value=""></asp:ListItem>
                                                    <asp:ListItem Value="initiator"> Initiator</asp:ListItem>
                                            ...
                                            <label>Status</label>
                                            <div class="form-group">
                                                <asp:DropDownList ID="Status_db" runat="server" class="form-control compulsory">
                                                    <asp:ListItem Value=""></asp:ListItem>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function newrecord() {
            //clear form
            document.getElementById('<%=Login_db.ClientID %>').value = '';
                   document.getElementById('<%=Group_Id_db.ClientID %>').value = '';
                   document.getElementById('<%=UserType_db.ClientID %>').value = '';
